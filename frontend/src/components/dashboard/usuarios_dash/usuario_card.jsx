...
export default function UsuarioCard({ usuario, onDelete, onEdit }) {
    ...
    return (
        <div className={styles.user_card}>
            <div className={styles.id}>{usuario.id}</div>
            ...
            <div className={styles.name}>{formatedName(usuario.name)}</div>
            ...
            <div className={styles.actions}>
                <button className={styles.edit} onClick={() => onEdit(usuario)}>
                ...
                <button className={styles.delete} onClick={() => onDelete(usuario._id)}>
